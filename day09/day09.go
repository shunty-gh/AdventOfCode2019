...
func main() {
	originalInput, err := inputAsInt64Array("./day09-input.txt")
	if err != nil {
		log.Fatal(err)
	}
...
func runProgram(program []int64, input int) (result int64, err error) {
